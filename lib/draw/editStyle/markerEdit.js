...
var MarkerEdit = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.upDataFun = function upDataFun(_this, _type, _key) {
    if (_type === 'addMarkerData') {
      var newobj = Object.assign(_this.props.addMarkerData, _this.state.addMarkerData);

      if (newobj.info) {
        if (_key === 'imgSrc') {
          newobj.info.setIcon((0, _defaultParame.getIcons)(newobj[_key]));
        }

        var newoblLde = newobj.info.getLabel() ? newobj.info.getLabel() : false;
