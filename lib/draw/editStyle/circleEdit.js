...
var CircleEdit = /*#__PURE__*/function (_React$Component) {
  _inheritsLoose(CircleEdit, _React$Component);

  // load
  function CircleEdit(props) {
    var _this2;
  ...
  var _proto = CircleEdit.prototype;
  ...
  // out
  _proto.componentWillUnmount = function componentWillUnmount() {} // 添加圆数据
  ;

  _proto.addCircledataFun = function addCircledataFun(type) {
    var _this$props = this.props,
        map = _this$props.map,
        resultMapView = _this$props.resultMapView;
    var fatherData = this.props.addCircleData;
    var chicerData = this.state.addCircleData;
    var newCircledata = Object.assign(this.props.addCircleData, this.state.addCircleData);
  ...
  _proto.upDataFun = function upDataFun(_this, _type, _key) {
    if (_type === 'addCircleData') {
      var newobj = Object.assign(_this.props.addCircleData, _this.state.addCircleData);
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("span", null, "\u8FB9\u6846\u7C7B\u578B\uFF1A"), /*#__PURE__*/_react.default.createElement(_select.default, {
      ...
      placeholder: "\u8BF7\u9009\u62E9",
      defaultValue: 'solid',
      onChange: _componutils.setBorderType.bind(this, 'addCircleData')
      ...
      style: {
        background: addCircleData.style.fillColor
      }
    }) : /*#__PURE__*/_react.default.createElement("i", {
      onClick: _componutils.setColorFun.bind(this, 1, true, 'fillColor', addCircleData.style.fillColor),
      style: {
        background: addCircleData.style.fillColor
      }
    }), isColorShowName === 'fillColor' ? /*#__PURE__*/_react.default.createElement("span", {
      className: "drawingmanagerutil_classBtn",
      onClick: _componutils.setColorFun.bind(this, 2, false, 'addCircleData', 'fillColor', colorData)
      ...
      style: {
        background: addCircleData.style.strokeColor
      }
    }) : /*#__PURE__*/_react.default.createElement("i", {
      onClick: _componutils.setColorFun.bind(this, 1, true, 'strokeColor', addCircleData.style.strokeColor),
      style: {
        background: addCircleData.style.strokeColor
      }
    }), isColorShowName === 'strokeColor' ? /*#__PURE__*/_react.default.createElement("span", {
      className: "drawingmanagerutil_classBtn",
      onClick: _componutils.setColorFun.bind(this, 2, false, 'addCircleData', 'strokeColor', colorData)
    }, "\u9009\u62E9") : /*#__PURE__*/_react.default.createElement("span", {
      className: "drawingmanagerutil_classBtn",
      onClick: _componutils.setColorFun.bind(this, 1, true, 'strokeColor', addCircleData.style.strokeColor)
      ...
      min: 1,
      max: 200,
      value: addCircleData.style.strokeWeight,
      onChange: _componutils.setWidthdataFun.bind(this, 'addCircleData', 'strokeWeight')
      ...
      placeholder: "\u540D\u79F0",
      maxLength: 45,
      value: addCircleData.name,
      onChange: _componutils.setNamedataFun.bind(this, 'addCircleData')
      ...
      checked: addCircleData.isClick,
      onChange: _componutils.isClickFun.bind(this, 'addCircleData')
      ...
      checkedChildren: "\u5F00\u542F",
      unCheckedChildren: "\u5173\u95ED",
      checked: addCircleData.isDbClick,
      onChange: _componutils.isDbClickFun.bind(this, 'addCircleData')
    }), /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement(_button.default, {
      type: "primary",
      size: 'small',
      onClick: function onClick() {
        return _this3.addCircledataFun(1);
      }
      ...
      size: 'small',
      onClick: function onClick() {
        return _this3.addCircledataFun(2);
      },
      style: {
        marginLeft: '0.2rem'
      }
...
var _default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(CircleEdit);
