...
function setFontdataFun(value, e) {
  ...
  this.setState((_this$setState = {}, _this$setState[value] = data, _this$setState));
} // 修改名字建筑物
...
function setWidthdataFun(value, key, e) {
  ...
  var data = this.state[value];
  data.style[key] = e;
  this.setState((_this$setState3 = {}, _this$setState3[value] = data, _this$setState3));
} // 设置边框类型
...
function setBorderType(value, e) {
  ...
  this.setState((_this$setState4 = {}, _this$setState4[value] = data, _this$setState4));
